...
imgElon = face_recognition.load_image_file('G:/face/028114280001/2023-08-31 10_27_17/人像照.jpg')  # 加载图片
imgElon = cv2.cvtColor(imgElon, cv2.COLOR_BGR2RGB)  # 将BGR彩色图像转化为RGB彩色图像
imgTest = face_recognition.load_image_file('G:/face/028114280001/2023-08-31 10_27_17/身份证反面照.jpg')
...
cv2.imshow('人像', imgElon)
cv2.imshow('身份证', imgTest)
# key = cv2.waitKey(0)
# if key == 27:  # 按ESC键退出
