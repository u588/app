...
def pltL(date, Data):
    c = (
        ...
        .set_global_opts(
            ...
            legend_opts=opts.LegendOpts(type_='scroll',pos_top='10%',pos_right='-2%',is_show=True ,selector=True,orient='vertical',item_width=35),
...
grid_chart = (Grid(opts.InitOpts(width="1800px", height="600px"))
              .add(pltL(dateD,DataD), grid_opts=opts.GridOpts(border_width=0, pos_left="8%", pos_right="12%",pos_top='5%',height='12%',))
              .add(pltL(dateM,DataM), grid_opts=opts.GridOpts(border_width=0, pos_left="8%", pos_right="12%",pos_top='24%',height='12%',))
              .add(pltL(dateJ,DataJ), grid_opts=opts.GridOpts(border_width=0, pos_left="8%", pos_right="12%",pos_top='43%',height='12%',))
              .add(pltL(dateS,DataS), grid_opts=opts.GridOpts(border_width=0, pos_left="8%", pos_right="12%",pos_top='63%',height='12%',))
              .add(pltL(dateA,DataA), grid_opts=opts.GridOpts(border_width=0, pos_left="8%", pos_right="12%",pos_top='80%',height='9%',))
            )
