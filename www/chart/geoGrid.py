...
def Kchart(CodeId):
    ...
    # return grid_chart
    return overlap_kline_line,Overlap_ADOSC_Vol,Overlap_MACD_DIF




def geoo(CodeId):
    ka,kb,kc= Kchart(CodeId)
    grid_chart = Grid()
    grid_chart.add_js_funcs("var barData = {}".format(d))
    ...
    .add(ka, grid_opts=opts.GridOpts(pos_left="4%", pos_right="2%", pos_top="0%"))
    # .add(kb, grid_opts=opts.GridOpts(pos_left="4%", pos_right="2%", pos_top="50%"))
    # .add(kc, grid_opts=opts.GridOpts(pos_left="4%", pos_right="2%", pos_top="60%"))
    # .add(sBar(CodeId), grid_opts=opts.GridOpts(pos_left="4%", pos_right="2%", pos_top="47%",height="5%"))
    # .add(iBar(CodeId), grid_opts=opts.GridOpts(pos_left="4%", pos_right="2%", pos_top="60%",height="5%"))
    )
    return grid