...
engD = create_engine('postgresql+psycopg://sa:11111111@10.3.18.56:5432/StockFina')
engF = create_engine('postgresql+psycopg://sa:11111111@10.3.18.56:5432/Funds')
...
def line(StockID) -> Line:
    ...
    c = (
        ...
        .add_xaxis(date)
        .set_global_opts(legend_opts=opts.LegendOpts(type_='scroll',pos_right='-1%',pos_top='8%',is_show=True),
                         title_opts=opts.TitleOpts(title=StockID, pos_left="center",pos_top="1"))
    )
