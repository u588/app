...
eng = create_engine('postgresql+psycopg://sa:11111111@10.145.254.56/tdxStocks')
...
akStockLists.set_index('StockCode').to_sql('akStocksList', eng, if_exists='replace')

print('akStockList update ! ')
eng.dispose()