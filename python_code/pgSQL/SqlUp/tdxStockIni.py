...
StockLists = ['300035', '300036', '300154', '300255', '300774', '300814', '300844', '300964', '300994', '301024', '301025', '301026', '301027', '301028', '301029', '301030', '301031', '301032', '301033', '301035', '301036', '301037', '301038', '301040', '301041', '301042', '301043', '301045', '601921', '605028', '605056', '605167', '605365']
...
with api.connect('119.147.212.81', 7709):
    try:
        for i, StockCode in enumerate(StockLists):
            ...
            start = 5000
            while start >= 0:
                df = api.to_df(api.get_security_bars(Cate, nn, StockCode, start, 500))
                start = start - 500
