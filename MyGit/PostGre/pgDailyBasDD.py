...
eng = create_engine('postgresql+psycopg2://sa:11111111@10.3.18.56:5432/DailyBas')
...
tickersRawData = pro.daily_basic(trade_date=dateToday)
tickersRawData.rename(columns={'trade_date':'datetime'}, inplace=True)
