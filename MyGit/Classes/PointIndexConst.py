...
def GetIndexConst(day, file, IndexValue, IndexConst):
    # Indexs = pd.read_csv('f:/IndexsSet/I' + day + 'Point' + file + '.csv', dtype={'index_code':object})['index_code'].tolist()[:8]
    Indexs = IndexValue['index_code'].tolist()[:8]
    ...
    Consts.to_csv('f:/StocksSet/S' + day + 'Point' + file + 'Const.csv', encoding='utf8')
    print('得到', day, '优选股')
    return Consts
