...
# eng.execute('DROP TABLE IF EXISTS "csIndexCons";')
    ...
    def getData(codeID):
        ...
        a = pd.read_excel(byte_stream,index_col=None, header=None,skiprows=1,dtype={1:object,4:object})[[1,2,4,5,9]]
    ...
    ls = pd.read_sql('tdxIndexs', con=conn)
    ...
    for codeID in IndexLists:
        try:
            ...
            Data.to_sql('csIndexCons', con=conn , if_exists='append')
