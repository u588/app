...
StockList = pd.read_excel('/home/ts/app/TDXapp/Biz_FailureListB.xlsx', dtype={'code':str})
n = 0
FailureList = []
while n < len(StockList):
    try:
        ...
        pass
    n = n + 1
StockList.iloc[FailureList].to_excel('/home/ts/app/TDXapp/Biz_FailureListB.xlsx', index=False)
eng.dispose()
engs.dispose()
