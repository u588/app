...
indexDP.set_index('IndexCode').to_excel('G:/Gitee/App/TDXapp/tdxAppData/akIndexDP.xlsx')

# indexNum = ak.index_all_cni()[['指数代码','指数简称','样本数']].rename(columns={'指数代码':'IndexCode','指数简称':'IndexName','样本数':'Num'})
# indexNum.set_index('IndexCode').to_excel('G:/Gitee/App/TDXapp/tdxAppData/akIndexNum.xlsx')
print('ok !')