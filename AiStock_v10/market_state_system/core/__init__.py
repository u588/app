"""
AiStock V9 Market State System — Core Module

Core engine components for the market state quantification system.

V9 Upgrade: ContractManager fully ported from V7 + xlsx code table alignment

Engines:
  ContractManager                — 动态合约代码推导引擎 (V7移植 + code/code_name双码制)
...
from .contract_manager import (
    ...
    OptionContractGroup,
    COMMODITY_DELIVERY_MONTHS,
    VARIETY_MARKET_CODE,
    VARIETY_MARKET_TYPE,
    MONITORED_COMMODITIES,
    INDEX_FUTURES_CONFIG,
    OPTION_UNDERLYING_CONFIG,
)
