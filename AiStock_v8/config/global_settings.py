...
"""
AiStock V8 全局系统常量配置
基于V7升级：整合外盘期货四维信号 + 统一期权代码解析 + 宏观指标体系
"""
...
DATABASE_ENGINES = {
    'index_db': get_db_url('DB_INDEX', 'postgresql://user:pass@10.3.18.56:5432/tdxIndex'),
    'stock_db': get_db_url('DB_STOCK', 'postgresql://user:pass@10.3.18.56:5432/stock'),
    'stock_base_db': get_db_url('DB_STOCK_BASE', 'postgresql://user:pass@10.3.18.56:5432/stock_base'),
    'stock_fs_db': get_db_url('DB_STOCK_FS', 'postgresql://user:pass@10.3.18.56:5432/stock_fs'),
    'index_pe_db': get_db_url('DB_INDEX_PE', 'postgresql://user:pass@10.3.18.56:5432/csiIndexPE'),
}
...
SYSTEM_NAME = "AiStock V8 A股市场状态量化系统"
